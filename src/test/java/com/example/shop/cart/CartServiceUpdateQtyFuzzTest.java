...
public class CartServiceUpdateQtyFuzzTest {
    ...
    @FuzzTest
    void updateQtyFuzzTest(FuzzedDataProvider data) {
        ...
        String productIdToUpdate = data.pickValue(new String[]{"p1", data.consumeString(10)});
        int newQty = data.consumeInt();

        try {
            service.updateQty(cartId, productIdToUpdate, newQty);
